...
export const ELI_CARTA_PRESENTACION_DEFAULT: string[] = [
  "Soy Eliana Gerkelis, Atleta federada Argentina, recientemente campeona provincial en 1.500mts llanos y fundadora de MIRARTE. Me especializo en pestañas y cejas, combinando técnicas de alta calidad, atención personalizada y un profundo compromiso con la seguridad y el bienestar de cada clienta.",
  ...
  "Para mí, cada mirada es única. Mi objetivo es es potenciar la belleza natural de cada mujer, que te sientas única, confiada y verdaderamente cuidada.",
]
