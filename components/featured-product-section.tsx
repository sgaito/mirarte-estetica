...
import {
  X, Check, MessageCircle, Droplets, Zap, Sparkles, ZoomIn,
        ...
        <div className="relative mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center gap-10 md:flex-row md:gap-14 lg:gap-20">
            ...
            <FadeIn delay={0.12} className="flex w-full flex-col items-start gap-5 md:w-[54%] lg:w-[58%]">
              ...
              <button
                onClick={() => setOpen(true)}
                className="inline-flex w-full items-center justify-center rounded-full bg-primary px-6 py-2.5 text-xs font-medium text-primary-foreground shadow transition-all hover:shadow-md hover:brightness-105 active:scale-95 sm:w-auto sm:px-8"
                style={{ fontFamily: "var(--font-display), Montserrat, sans-serif" }}
              >
                Consultar por WhatsApp
              </button>
