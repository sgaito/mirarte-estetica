...
export function PrefooterCta() {
  return (
    <section className="relative overflow-hidden bg-secondary pt-8 pb-14 lg:pt-10 lg:pb-16">
      ...
      <div className="relative mx-auto flex max-w-xl flex-col items-center gap-5 px-6 text-center lg:px-8">
        <FadeIn>
          <h2 className="text-2xl font-light tracking-tight text-foreground sm:text-3xl">
            ¿Lista para <span className="heading-emphasis">reservar</span>?
          </h2>
        </FadeIn>
        <FadeIn delay={0.06}>
          <Link
            ...
            className="inline-flex h-[3.5rem] w-full max-w-xs items-center justify-center gap-2.5 whitespace-nowrap rounded-full bg-primary px-6 text-sm font-semibold tracking-wide text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:shadow-xl hover:shadow-primary/30 hover:brightness-110 active:scale-[0.98] sm:h-14 sm:max-w-md sm:text-[15px]"
          >
