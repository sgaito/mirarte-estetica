...
const floatingBtn =
  "flex h-11 w-11 items-center justify-center rounded-full border border-border/70 bg-background/90 text-primary shadow-md backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:shadow-lg active:scale-95"
