        ...
        <FadeIn>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
              Resultados reales que potencian tu belleza natural y transforman tu mirada.
            </p>
          </div>
        </FadeIn>
      </div>
