      ...
      <div className="relative mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:mt-12 sm:flex-row sm:justify-center sm:gap-4">
            <Link
              href="#contacto"
              className="w-full rounded-full bg-primary px-8 py-3.5 text-sm font-medium text-primary-foreground shadow-md transition-all hover:shadow-lg hover:brightness-105 sm:w-auto sm:py-4 sm:text-base"
            >
              Reservar Turno
            </Link>
            <Link
              href="#servicios"
              className="w-full rounded-full border border-border bg-background px-8 py-3.5 text-sm font-medium text-foreground transition-all hover:bg-secondary sm:w-auto sm:py-4 sm:text-base"
            >
              Ver Servicios
            </Link>
          </div>
